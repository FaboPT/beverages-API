...
trait ResponseAPI
{
     ...
     * @return JsonResponse
     */
    public function coreResponse(int $statusCode = Response::HTTP_OK, string $message = null, bool $isSuccess = true, object $data = null, string $nameData = 'data'): JsonResponse
    {
